...
public class ShiftReportController {
    ...
    public ResponseEntity<List<ShiftReportDTO>> getShiftByCashier(@PathVariable Long cashierId) throws Exception {
        return ResponseEntity.ok(
    ...
    public ResponseEntity<List<ShiftReportDTO>> getShiftByBranch(@PathVariable Long branchId) throws Exception {
        return ResponseEntity.ok(
